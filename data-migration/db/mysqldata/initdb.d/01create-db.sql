...
CREATE TABLE IF NOT EXISTS `callcenter`.`t_complaint` (
  ...
  `complaint_title` TEXT NULL DEFAULT NULL COMMENT '민원내용',
  `complaint_content` TEXT NULL DEFAULT NULL COMMENT '문의상세',
  `complaint_processing` TEXT NULL DEFAULT NULL COMMENT '처리내용',
  `complaint_handling` TEXT NULL DEFAULT NULL COMMENT '민원처리',
